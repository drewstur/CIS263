...
public class Ball
{
	   ...
	   public String toString()
	   {
		   ...
		   if(isInflated())
	   	   {
		       toStringMsg = "inflated ball with an air pressure of " +this.getAirPressure();
		   }
		   else
		   {
			   toStringMsg = "uninflated ball with an air pressure of " +this.getAirPressure();
		   }
		   return toStringMsg;
	   }
}